<svg width="18" height="18" viewBox="0 0 18 18" version="1.1" id="svg142">
	...
	<defs id="defs116">
		<filter
			...
			id="filter-1"
		>
			<feOffset dx="0" dy="1" in="SourceAlpha" result="shadowOffsetOuter1" id="feOffset94" />
			<feGaussianBlur
				stdDeviation="0.5"
			...
			<feColorMatrix
				...
				id="feColorMatrix98"
			/>
			<feOffset dx="0" dy="0" in="SourceAlpha" result="shadowOffsetOuter2" id="feOffset100" />
			<feGaussianBlur
				stdDeviation="0.5"
